...
export const uniformSchema = {
  ...
  uTerrainAmplitude: target('float', 'smooth', ({ settings }) => settings.terrain.amplitude),
  uTerrainRoughness: target('float', 'smooth', ({ settings }) => settings.terrain.roughness),
  uTerrainScale: target('float', 'smooth', ({ settings }) => settings.terrain.scale),
  ...
  uWaterLevel: target('float', 'smooth', ({ settings }) => settings.water.level),
  uPsychedelicIntensity: target('float', 'smooth', ({ settings }) => settings.generation.psychedelicIntensity),
  uMechanicalIntensity: target('float', 'smooth', ({ settings }) => settings.generation.mechanicalIntensity),
  uRitualIntensity: target('float', 'smooth', ({ settings }) => settings.generation.ritualIntensity),
  uMountains: target('float', 'smooth', ({ settings }) => settings.generation.mountains),
  uFolds: target('float', 'smooth', ({ settings }) => settings.generation.folds),
  uValleys: target('float', 'smooth', ({ settings }) => settings.generation.valleys),
  uRivers: target('float', 'smooth', ({ settings }) => settings.generation.rivers),
  uDunes: target('float', 'smooth', ({ settings }) => settings.generation.dunes),
  ...
  uTerraces: target('float', 'smooth', ({ settings }) => settings.generation.terraces),
