...
export const TREE_CELL_JITTER = 1.2
export const TREE_SAMPLE_BOUND = 8.2
export const TREE_CELL_MARCH_GUARD = 2.2
...
export const PLANT_DETAIL_NEAR = 32
export const PLANT_DETAIL_FAR = 54
export const TREE_MARCH_SCALE = 0.48
export const STAIR_STEP_COUNT = 12
export const STAIR_WIDTH = 1.55
